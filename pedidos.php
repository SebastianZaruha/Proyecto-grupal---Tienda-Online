                        ...
                        while ($row = mysqli_fetch_assoc($result_pedidos)): ?>
                            <div class="accordion-item">
                                ...
                                <div id="collapse<?php echo $counter; ?>"
                                    class=" p-3 accordion-collapse collapse <?php echo $counter == 1 ? 'show' : ''; ?>"
                                    aria-labelledby="heading<?php echo $counter; ?>" data-bs-parent="#pedidosAccordion">
                                    ...
                                    while ($row_2 = mysqli_fetch_assoc($result_pedidos_productos)):
                                        ...
                                        <div class="col-12 rounded my-3  " style="background-color: #f4e6e66b; height: 25vh">
                                            <div class="accordion-body ">
                                                ...
                                                <p class="m-0">Nombre del producto:
                                                    <?php echo $row_2['nombre']; ?>
                                                </p>


                                                <p class="m-0 ">Fecha estimada de entrega:
                                                    <?php $date = date_create($row_2['fecha_estimada']);
                                                    $formatted_date = date_format($date, "d M Y");
                                                    echo $formatted_date; ?>
                                                </p>
                                                <p class="m-0">Dirección de envío:
                                                    <?php echo $row_2['direccion']; ?>
                                                </p>
                                                <p class="m-0">Factura: <a class="text-primary"
                                                        href="factura.php?id_factura=<?php echo $row_2['id_factura']; ?>">Descargar
                                                        factura</a></p>
