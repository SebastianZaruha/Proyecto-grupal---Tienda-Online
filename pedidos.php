                    ...
                    <div class="accordion" id="pedidosAccordion">
                        ...
                        while ($row = mysqli_fetch_assoc($result_pedidos)) : ?>
                            <div class="accordion-item">
                                ...
                                <div id="collapse<?php echo $counter; ?>" class=" p-3 accordion-collapse collapse" aria-labelledby="heading<?php echo $counter; ?>" data-bs-parent="#pedidosAccordion">
                                    ...
                                    ?>
                                        <div class="col-12 rounded my-3  " style="background-color: #847c7c6b; height: 25vh">
                                            <div class="accordion-body ">
                                                ...
                                                <p class="m-0">Factura: <a class="text-primary" href="factura.php?id_factura=<?php echo $row_2['id_factura']; ?>">Descargar factura</a></p>
