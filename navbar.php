...
<head>
    ...
    <link rel="icon" type="image/svg+xml" sizes="32x32" href="assets/favicon.svg">
                            ...
                            <form action="login2.php" method="POST">
                                <div class="mb-3">
                                    ...
                                    <div class=" d-flex justify-content-center mt-3">
                                        <button class="acceder btn mt-2 fs-5 text-white" style="background-color: #847C7C; width:100%; height: 5vh;" type="submit">ACCEDER</button>
                                    </div>
                                </div>
                            </form>
